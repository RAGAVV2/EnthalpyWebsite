...
import Navbar from '../navbar/nav'; // Assuming the Navbar component file is in the same directory
...
I hope this example paragraph meets your requirements! Let me know if there's anything else I can assist you with.</p>
    </div>
  );
};
